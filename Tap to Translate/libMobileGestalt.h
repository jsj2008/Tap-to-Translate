...
/*
 CFStringRef properties[] = {kMGDiskUsage,
 kMGModelNumber,
 kMGSIMTrayStatus,
 kMGSerialNumber,
 kMGMLBSerialNumber,
 kMGUniqueDeviceID,
 kMGUniqueDeviceIDData,
 kMGUniqueChipID,
 kMGInverseDeviceID,
 kMGDiagnosticsData,
 kMGDieID,
 kMGCPUArchitecture,
 kMGPartitionType,
 kMGUserAssignedDeviceName,
 
 // Bluetooth
 kMGBluetoothAddress,
 
 // Battery
 kMGRequiredBatteryLevelForSoftwareUpdate,
 kMGBatteryIsFullyCharged,
 kMGBatteryIsCharging,
 kMGBatteryCurrentCapacity,
 kMGExternalPowerSourceConnected,
 
 // Baseband
 kMGBasebandSerialNumber,
 kMGBasebandCertId,
 kMGBasebandChipId,
 kMGBasebandFirmwareManifestData,
 kMGBasebandFirmwareVersion,
 kMGBasebandKeyHashInformation,
 
 // Telephony
 kMGCarrierBundleInfo,
 kMGCarrierInstallCapability,
 kMGInternationalMobileEquipmentIdentity,
 kMGMobileSubscriberCountryCode,
 kMGMobileSubscriberNetworkCode,
 ...
 kMGFirmwareNonce,
 kMGFirmwareVersion,
 kMGFirmwarePreflightInfo,
 kMGIntegratedCircuitCardIdentifier,
 kMGAirplaneMode,
 kMGAllowYouTube,
 kMGAllowYouTubePlugin,
 kMGMinimumSupportediTunesVersion,
 kMGProximitySensorCalibration,
 kMGRegionCode,
 kMGRegionInfo,
 kMGRegulatoryIdentifiers,
 kMGSBAllowSensitiveUI,
 kMGSBCanForceDebuggingInfo,
 kMGSDIOManufacturerTuple,
 kMGSDIOProductInfo,
 kMGShouldHactivate,
 kMGSigningFuse,
 kMGSoftwareBehavior,
 kMGSoftwareBundleVersion,
 kMGSupportedDeviceFamilies,
 kMSupportedKeyboards,
 kMGTotalSystemAvailable,
 
 // Capabilities
 kMGAllDeviceCapabilities,
 kMGAppleInternalInstallCapability,
 kMGExternalChargeCapability,
 kMGForwardCameraCapability,
 kMGPanoramaCameraCapability,
 kMGRearCameraCapability,
 
 kMGHasAllFeaturesCapability,
 kMGHasBaseband,
 kMGHasInternalSettingsBundle,
 kMGHasSpringBoard,
 kMGInternalBuild,
 kMGIsSimulator,
 kMGIsThereEnoughBatteryLevelForSoftwareUpdate,
 kMGIsUIBuild,
 
 // Regional Behaviors
 kMGRegionalBehaviorAll,
 kMGRegionalBehaviorChinaBrick,
 kMGRegionalBehaviorEUVolumeLimit,
 kMGRegionalBehaviorGB18030,
 kMGRegionalBehaviorGoogleMail,
 kMGRegionalBehaviorNTSC,
 kMGRegionalBehaviorNoPasscodeLocationTiles,
 kMGRegionalBehaviorNoVOIP,
 kMGRegionalBehaviorNoWiFi,
 kMGRegionalBehaviorShutterClick,
 kMGRegionalBehaviorVolumeLimit,
 
 // Wireless
 kMGActiveWirelessTechnology,
 kMGWifiAddress,
 kMGWifiAddressData,
 kMGWifiVendor,
 
 // FaceTime
 kMGFaceTimeBitRate2G,
 kMGFaceTimeBitRate3G,
 kMGFaceTimeBitRateLTE,
 kMGFaceTimeBitRateWiFi,
 kMGFaceTimeDecodings,
 kMGFaceTimeEncodings,
 kMGFaceTimePreferredDecoding,
 kMGFaceTimePreferredEncoding,
 
 // Supports
 kMGDeviceSupportsFaceTime,
 kMGDeviceSupportsTethering,
 kMGDeviceSupportsSimplisticRoadMesh,
 kMGDeviceSupportsNavigation,
 kMGDeviceSupportsLineIn,
 kMGDeviceSupports9Pin,
 kMGDeviceSupports720p,
 kMGDeviceSupports4G,
 kMGDeviceSupports3DMaps,
 kMGDeviceSupports3DImagery,
 kMGDeviceSupports1080p,
 CFSTR("apple-internal-install"),
 CFSTR("UIParallaxCapability"),
 CFSTR("device-name-localized")};
 gestaltInfo = CFDictionaryCreateMutable(NULL, 0, &kCFTypeDictionaryKeyCallBacks, &kCFTypeDictionaryValueCallBacks);
 for(int i = 0; i < sizeof(properties)/sizeof(properties[0]); i++) {
 CFPropertyListRef answer = MGCopyAnswer(properties[i]);
 CFDictionarySetValue(gestaltInfo, properties[i], answer ? : "");
 }
 MSHookFunction(MGCopyAnswer, new_MGCopyAnswer, &original_MGCopyAnswer);
 */

/*
 static CFPropertyListRef (*original_MGCopyAnswer)(CFStringRef property);
 
 CFPropertyListRef new_MGCopyAnswer(CFStringRef property)
 {
 NSLog(@"asking for %@", (__bridge NSString*)property);
 if(property == kMGUniqueDeviceID) {
 NSLog(@"fuck you udid");
 }
 CFPropertyListRef r = CFDictionaryGetValue(gestaltInfo, property);
 NSLog(@"returning: %@", (__bridge NSString*)r);
 if(r) {
 NSLog(@"correct r");
 return r;
 } else {
