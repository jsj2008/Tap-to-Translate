...
- (void)_createAutoDisconnectTimer {
	if (_autoDisconnectTimer == nil) {
		// ticks every minute
		_autoDisconnectTimer = [NSTimer scheduledTimerWithTimeInterval:TTTIPC_AUTODISCONNECT_TICKTIME target:self selector:@selector(_autoDisconnectTimerTicks) userInfo:nil repeats:YES];
	}
}
